        ...
        IPointerDownHandler, IPointerUpHandler
    {
        ...
        public class TransitionEffect
        {
            ...
            protected float minDisplacement,
                ...
                defaultMinValue,
                defaultMaxValue,
                defaultMinDisplacement,
                defaultMaxDisplacement;
            ...
            public TransitionEffect(string label, float minValue, float maxValue, float minDisplacement,
                float maxDisplacement, AnimationCurve function, SimpleScrollSnap simpleScrollSnap)
            {
                this.label = label;
            ...
            public void Init()
            {
                ...
                if (showPanel)
                {
                    ...
                    // Function
                    function = EditorGUILayout.CurveField("Function", function, Color.white,
        ...
        public Vector2 size = new(400, 250);
        ...
        public List<TransitionEffect> transitionEffects = new();
        ...
        private Dictionary<int, Graphic[]> panelGraphics = new();
